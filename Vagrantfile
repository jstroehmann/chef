...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jaymz411-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jaymzorg"
  #   chef.validation_client_name = "jaymzorg-validator"
  #   chef.validation_key_path = ".chef/jaymzorg-validator.pem"
  # end
end
